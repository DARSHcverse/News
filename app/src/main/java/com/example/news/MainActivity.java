...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView inflation,wed,child,law;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataSource.add("wedding_trends_png.webp");
        dataSource.add("rsz_1gettyimages_157311703_b09b9b53d83d4f35bcbedf9ffb6c8a8b.jpg");
        dataSource.add("erferfef.jpg");
        dataSource.add("dwedwedwd.jpg");
...
//            holder.imageView.setImageDrawable(Drawable.createFromPath(dataSource.get(position)));
        }
        ...
        class MyHolder extends RecyclerView.ViewHolder
        {
            ...
            public MyHolder(@NonNull View itemView) {
                super(itemView);
                imageView=findViewById(R.id.Inflation);
            }
        }
    }
